...
float sparse_infer(MLP mlp, float *input_data, unsigned char* labels) {
    ...
    for (int n = 0; n < test_size; n++) {
        ...
        // Device compute
        sparse_fully_connected(s_input.values, s_input.indices, s_input.nnz, mlp.fc1_weights, mlp.fc1_biases, d_fc1_activations, n_hidden1);
        ...
        sparse_fully_connected(s_fc1_activations.values, s_fc1_activations.indices, s_fc2_activations.nnz, mlp.fc2_weights, mlp.fc2_biases, d_fc2_activations, n_hidden2);
        ...
        sparse_fully_connected(s_fc2_activations.values, s_fc2_activations.indices, s_fc2_activations.nnz, mlp.fc3_weights, mlp.fc3_biases, d_net_output, n_outputs);
